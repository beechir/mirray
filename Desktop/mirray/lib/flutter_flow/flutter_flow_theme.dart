...
class LightModeTheme extends FlutterFlowTheme {
  ...
  late Color primary = const Color(0xFF182026);
  late Color secondary = const Color(0xFFB28228);
  late Color tertiary = const Color(0xFF9F86C0);
  late Color alternate = const Color(0xFFEDE8DF);
  late Color primaryText = const Color(0xFFFFFFFF);
  late Color secondaryText = const Color(0xFF415A77);
  late Color primaryBackground = const Color(0xFFBE95C4);
  late Color secondaryBackground = const Color(0xFFE0B1CB);
  ...
  late Color success = const Color(0xFF7FB685);
  late Color warning = const Color(0xFFF2C57C);
  late Color error = const Color(0xFFEF6F6C);
